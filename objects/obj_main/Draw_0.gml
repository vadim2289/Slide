...
draw_text(global.x_+lengthdir_x(global.radius_+50,sector_r.rotation_start)
	,global.y_+lengthdir_y(global.radius_+50,sector_r.rotation_start)
	,sector_r.sector_id)
draw_text(global.x_+lengthdir_x(global.radius_+50,sector_u.rotation_start)
	,global.y_+lengthdir_y(global.radius_+50,sector_u.rotation_start)
	,sector_u.sector_id)
draw_text(global.x_+lengthdir_x(global.radius_+50,sector_l.rotation_start)
	,global.y_+lengthdir_y(global.radius_+50,sector_l.rotation_start)
	,sector_l.sector_id)
draw_text(global.x_+lengthdir_x(global.radius_+50,sector_d.rotation_start)
	,global.y_+lengthdir_y(global.radius_+50,sector_d.rotation_start)
	,sector_d.sector_id)